...
export const CATEGORY_TEMPLATES: Record<string, CategoryTemplate> = {
  ...
  video: {
    id: "video",
    name: "映像・動画コンテンツ",
    description: "映画・ドラマ・配信コンテンツ・映像制作など映像関連の項目",
    commission_rate: 15,
    referral_rate: 3,
    platform_rate: 12,
    product_fields: [
      { field: "content_type", label: "コンテンツ種別", required: true, type: "select", options: ["映画", "ドラマ", "アニメ", "ドキュメンタリー", "MV", "CM", "教育・研修", "ライブ配信", "VR/360", "その他"] },
      { field: "duration", label: "尺（分）", required: false, type: "number" },
      { field: "resolution", label: "解像度", required: false, type: "select", options: ["SD", "HD (720p)", "Full HD (1080p)", "4K", "8K"] },
      { field: "format", label: "納品形式", required: false, type: "select", options: ["ストリーミング", "ダウンロード", "DVD", "Blu-ray", "データ納品", "上映権"] },
      { field: "director", label: "監督・ディレクター", required: false, type: "text" },
      { field: "cast", label: "出演者・キャスト", required: false, type: "text" },
      { field: "language", label: "言語", required: false, type: "select", options: ["日本語", "英語", "中国語", "韓国語", "多言語対応", "字幕付き", "吹替あり"] },
      { field: "rating", label: "レーティング", required: false, type: "select", options: ["G（全年齢）", "PG12", "R15+", "R18+", "指定なし"] },
      { field: "copyright_holder", label: "著作権者", required: true, type: "text" },
      { field: "license_type", label: "ライセンス種別", required: true, type: "select", options: ["買い切り", "期間限定", "上映権のみ", "配信権のみ", "全権利", "カスタム"] },
    ],
    lot_fields: [
      { field: "license_start", label: "ライセンス開始日", required: false, type: "date" },
      { field: "license_end", label: "ライセンス終了日", required: false, type: "date" },
      { field: "territory", label: "配信/上映地域", required: false, type: "select", options: ["日本国内", "アジア", "全世界", "カスタム"] },
      { field: "screening_count", label: "上映回数制限", required: false, type: "number" },
    ],
  },
  general: {
    id: "general",
