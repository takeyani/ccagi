...
const comparisonRows: ComparisonRow[] = [
  ...
  },
  {
    ...
    ours: "BtoB（見積書・請求書・納品書）+ BtoC（領収書・購入明細・返品伝票）をプラットフォーム内で完結。インボイス制度対応",
  },
  {
    label: "商品掲載の単位",
    traditional: "商品コード（SKU）単位で掲載",
    ours: "SKU + ロット（在庫単位）で掲載。同じSKUでもカテゴリーに応じた条件（食品:賞味期限、アパレル:色/サイズ、家電:製造日/ファームウェア等）で在庫を分けて管理",
  },
  {
    label: "在庫管理",
    traditional: "自社システム or 手動管理（賞味期限の混在あり）",
    ours: "ロット別管理で賞味期限・製造日を一致させた在庫追跡 + WMS/IoT連携",
  },
  {
    label: "アフィリエイト",
...
const advantages = [
  ...
  },
  {
    ...
    desc: "クリエイターがメーカーから販売許可を取得し、卸値に利益を上乗せしたLPを作成。卸値と販売価格の差分がクリエイターの利益になり、広告費ゼロで集客できます。",
  },
  {
    icon: "📦",
    title: "箱単位〜ロット全量まで柔軟に対応",
    desc: "ロット内の商品を箱単位で購入可能。1箱からでもOK、まとめ買いもOK。箱をばらさずに販売できるため、品質管理もシンプル。カートン入数・最小注文数量・成分表など、BtoBに必要な情報を標準搭載しています。",
  },
  {
    icon: "📝",
    title: "帳票・決済をワンストップで",
  ...
  },
  {
    icon: "🏷️",
    title: "オークション・自動入札",
    desc: "従来のECにはない、オークション機能。箱単位での入札が可能で、自動入札で手間なく最適価格での取引を実現します。",
  },
];
