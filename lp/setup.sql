...
create policy "Admin can manage step_mail_steps" on public.step_mail_steps for all using (exists (select 1 from public.step_mail_campaigns c where c.id = campaign_id and public.is_admin()));
